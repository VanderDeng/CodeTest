...
//        else
//        {
//            System.out.println(world.getGridSize());
//            System.out.println(checkDigit(world.getGridSize()));
//            System.out.println(world.getCommands());
//            System.out.println(checkCommand(world.getCommands()));
//            System.out.println(checkXY(world.getZombie()));
//            System.out.println(checkCreatures(world.getCreatures()));
//
//            return null;
//        }
    }
